...
<template>
  <div class="md:px-[10vw] pb-4">
    ...
    <div class="py-6 px-8 text-center">
      <h1 class="md:text-6xl text-5xl tracking-wider font-serif"><span style="font-family: 'HarmonyOS Sans SC', 'HarmonyOS Sans', 'PingFang SC', 'Microsoft YaHei', sans-serif;">F<span class="text-red-500">ast</span> S<span class="text-red-500">end</span></span></h1>
      <p
